...
public class GameVisitor implements PawnVisitor {
    ...
    public void accept(DeckPlayer firstPlayer, DeckPlayer secondPlayer) {
        ...
        while (firstPlayer.getDeck().getLength() != 0 && secondPlayer.getDeck().getLength() != 0) {
            ...
            if ((firstPlayerCard != 9 && secondPlayerCard != 0) && (firstPlayerCard == 0 && secondPlayerCard == 9 || firstPlayerCard > secondPlayerCard)) {
